...
import {ModalInstanceStack} from '../models/ModalInstanceStack';
...
import {
    OneButtonPreset,
    oneButtonPresetFactory,
    TwoButtonPreset,
    twoButtonPresetFactory
} from '../presets';
...
export class Modal {
    ...
    alert(): OneButtonPreset {
        return oneButtonPresetFactory(<any>{ isBlocking: false })
            .fluentObject.modal(this);
    }

    prompt(): OneButtonPreset {
        return oneButtonPresetFactory(<any>{ isBlocking: true, keyboard: null })
            .fluentObject.modal(this);
    }

    confirm(): TwoButtonPreset {
        // return new TwoButtonPresetFactory(<any>{ isBlocking: true, keyboard: null })
        //     .fluentObject.modal(this);
        return twoButtonPresetFactory(<any>{ isBlocking: true, keyboard: null })
            .fluentObject.modal(this);
    }

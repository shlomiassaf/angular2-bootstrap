import {Modal, OneButtonPreset, TwoButtonPreset} from '../../../components/modal/modal';

export function alert(modal: Modal): OneButtonPreset {
    return modal.alert()
        .size('lg')
...
export function prompt(modal: Modal): OneButtonPreset {
    return modal.prompt()
        .size('lg')
...
export function confirm(modal: Modal): TwoButtonPreset {
...
export function inElement(modal: Modal): OneButtonPreset {
    return modal.prompt()
        .size('sm')
